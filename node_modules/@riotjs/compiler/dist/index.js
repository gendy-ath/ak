...
function comment(state, data, start) {
  ...
  pushComment$1(state, start, end + str.length);
 ...
 * @private
 */
function pushComment$1(state, start, end) {
  flush(state);
  state.pos = end;
...
function compile(source, opts = {}) {
  ...
  const { template: template$1, css: css$1, javascript: javascript$1 } = parser(options).parse(code).output;
